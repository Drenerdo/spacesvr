...
public class TOD_Camera : MonoBehaviour
{
	...
	protected void Update()
	{
		...
		if (cameraComponent.clearFlags == CameraClearFlags.Skybox)
		{
			Debug.LogWarning("Skybox camera clear flags are redundant with a sky dome. Changing camera to solid color clear flags.", cameraComponent);
