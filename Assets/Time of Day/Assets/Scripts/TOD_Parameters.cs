...
{
	/// Color of the light that hits the atmosphere at day.
	...
	/// Color of the light that hits the ground at day.
	/// Interpolates from left (day) to right (night).
...
{
	/// Color of the light that hits the atmosphere at night.
	/// Interpolates from left (day) to right (night).
	...
	/// Color of the light that hits the ground at night.
	/// Interpolates from left (day) to right (night).
	...
	/// Color of the god rays at night.
	/// Interpolates from left (day) to right (night).
